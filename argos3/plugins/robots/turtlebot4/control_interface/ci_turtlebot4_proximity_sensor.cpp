...
namespace argos
{
   ...
   CCI_Turtlebot4ProximitySensor::CCI_Turtlebot4ProximitySensor() : m_tReadings(7)
   {

      // Set the values for the proximity sensor angles
      m_tReadings[0].Angle = -CRadians::PI / 2.75f;  // -65
      m_tReadings[1].Angle = -CRadians::PI / 4.736f; // -38
      m_tReadings[2].Angle = -CRadians::PI / 9.0f;   // -20
      m_tReadings[3].Angle = -CRadians::PI / 60.0f;  // -3°
      m_tReadings[4].Angle = CRadians::PI / 12.630f; // +60
      m_tReadings[5].Angle = CRadians::PI / 5.294f;  // +60
      m_tReadings[6].Angle = CRadians::PI / 2.7565f; // +65
